...
namespace CleanArchitecture.Core.Interfaces
{
    public interface IClubRepositoryAsync : IGenericRepositoryAsync<Club>
    {
        ...
        Task<(IReadOnlyList<ClubJoinRequestDto> Data, int TotalCount)> GetJoinRequestsPagedAsync(
            int clubId,
            int pageNumber,
            int pageSize,
            string searchValue,
        ...
        Task<ClubHistoryDto> GetClubHistoryAsync(int clubId);
        ...
        Task AddJoinRequestAsync(ClubJoinRequest joinRequest);
